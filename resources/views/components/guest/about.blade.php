...
@section('content')
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-benefits-area">
                                    <img src="guest/img/core-img/b1.png" alt="">
                                    <h5>Quality Products</h5>
                                    <p>We ensure that our quality products make you supprise. </p>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-benefits-area">
                                    <img src="guest/img/core-img/b2.png" alt="">
                                    <h5>Perfect Service</h5>
                                    <p>We are proud of our customer care and delivery service. </p>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-benefits-area">
                                    <img src="guest/img/core-img/b3.png" alt="">
                                    <h5>100% Natural</h5>
                                    <p>All products are grown from 100% natural</p>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="single-benefits-area">
                                    <img src="guest/img/core-img/b4.png" alt="">
                                    <h5>Environmentally friendly</h5>
                                    <p>The Environmental Protection Association has certified our farming model</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="section-heading text-center">
                        <h2>OUR NURSERY PLANTS</h2>
                        <p>We implement perfect nursery plants for you.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row align-items-center justify-content-between">
                    ...
                    <div class="alazea-service-area mb-100">
                        ...
                        <div class="single-service-area d-flex align-items-center">
                            ...
                            <div class="service-icon mr-30">
                                <img src="guest/img/core-img/s1.png" alt="">
                            </div>
                            <!-- Content -->
                            <div class="service-content">
                                <h5>Plants Care</h5>
                                <p>With 100+ experienced farmer, our plant care model is very special and guaranteed</p>
                            </div>
                        </div>
                        ...
                        <div class="single-service-area d-flex align-items-center">
                            <!-- Icon -->
                            <div class="service-icon mr-30">
                                <img src="guest/img/core-img/s2.png" alt="">
                            </div>
                            <!-- Content -->
                            <div class="service-content">
                                <h5>Pressure Water</h5>
                                <p>We are always up to date with new technologies. From there, build a suitable watering
                                    system</p>
                            </div>
                        </div>
                        ...
                        <div class="single-service-area d-flex align-items-center">
                            <!-- Icon -->
                            <div class="service-icon mr-30">
                                <img src="guest/img/core-img/s3.png" alt="">
                            </div>
                            <!-- Content -->
                            <div class="service-content">
                                <h5>Tree Service &amp; Trimming</h5>
                                <p>Every day our farmers carefully care for and prune to deliver quality and aesthetically
                                    pleasing products.</p>
                            </div>
                        </div>
                ...
                <div class="col-12 col-lg-6">
                    <div class="alazea-video-area bg-overlay mb-100">
                        <img src="guest/img/bg-img/23.jpg" alt="">
                        <a href="https://www.youtube.com/watch?v=sGRxxe9w1lk" class="video-icon">
    ...
    <section class="cool-facts-area bg-img section-padding-100-0"
        style="background-image: url(guest/img/bg-img/cool-facts.png);">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="single-cool-fact d-flex align-items-center justify-content-center mb-100">
                        <div class="cf-icon">
                            <img src="guest/img/core-img/cf1.png" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="single-cool-fact d-flex align-items-center justify-content-center mb-100">
                        <div class="cf-icon">
                            <img src="guest/img/core-img/cf3.png" alt="">
                        </div>
                        <div class="cf-content">
                ...
                <div class="col-12 col-sm-6 col-md-3">
                    <div class="single-cool-fact d-flex align-items-center justify-content-center mb-100">
                        <div class="cf-icon">
                            <img src="guest/img/core-img/cf4.png" alt="">
                        </div>
                        <div class="cf-content">
        ...
        <div class="side-img wow fadeInUp" data-wow-delay="500ms">
            <img src="guest/img/core-img/pot.png" alt="">
        </div>
    </section>
    <!-- ##### Cool Facts Area End ##### -->
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-member text-center mb-100">
                        ...
                        <div class="team-member-thumb">
                            <img src="guest/img/bg-img/team1.png" alt="">
                            <!-- Social Info -->
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-member text-center mb-100">
                        <!-- Team Member Thumb -->
                        <div class="team-member-thumb">
                            <img src="guest/img/bg-img/team2.png" alt="">
                            <!-- Social Info -->
                            <div class="team-member-social-info">
                                <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-member text-center mb-100">
                        <!-- Team Member Thumb -->
                        <div class="team-member-thumb">
                            <img src="guest/img/bg-img/team3.png" alt="">
                            <!-- Social Info -->
                            <div class="team-member-social-info">
                                <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-team-member text-center mb-100">
                        <!-- Team Member Thumb -->
                        <div class="team-member-thumb">
                            <img src="guest/img/bg-img/team4.png" alt="">
                            <!-- Social Info -->
                            <div class="team-member-social-info">
                                <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
